...
@Autonomous(name="dumpBotAutoRedPerp", group="dumpBotConfig")
public class dumpBotAutoRedPerp extends LinearOpMode {
...
//    protected void glyphBoi()
    ...
    protected void flip(){
        ...
        flipLeft.setPosition(0.52);
        flipRight.setPosition(0.52);
    ...
    protected void shakeItOff(double time){
        ...
        pushBoy.setPosition(0);
        //print(String.valueOf(-(imu.getZAngle() - angle)),5);
        //setDrive(-1);
        //holdUp(0.5);
        //setDrive(0);
